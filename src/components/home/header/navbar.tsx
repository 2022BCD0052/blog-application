        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div
              ...
              className="fixed inset-y-0 right-0 z-50 w-3/4 max-w-xs bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900 border-l border-gray-200 dark:border-gray-800 backdrop-blur-2xl md:hidden"
            >
